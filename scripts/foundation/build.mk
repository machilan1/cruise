...
dev-enterdb:
	...
	docker exec -it ${COMPOSE_PROJECT_NAME}-db-1 psql -U ${DB_USER} -d ${DB_NAME}
...
t-ser:
	...
	SEED_DISABLED=false ./testserver -test.v -test.run TestServer | go run cmd/logfmt/main.go

#dev-resetdb:
#	docker exec -it ${COMPOSE_PROJECT_NAME}-db-1 psql -U ${DB_USER} -d ${DB_NAME} -c "DROP SCHEMA public CASCADE; CREATE SCHEMA public;"
